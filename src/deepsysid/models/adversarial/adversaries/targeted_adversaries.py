...
class TargetedFgsm(Adversary):
    ...
    def attack(
        ...
        loss = mse(
            ...
            .squeeze().t()[self.target_variable],
            state.squeeze().t()[self.target_variable]
        )
...
class TargetedPgd(Adversary):
    ...
    def attack(
        ...
        for step in range(self.steps):
            ...
            advex, achieved_loss = targeted_fgsm.attack(
                advex,
                state,
                init_hx
            )
...
class TargetedPgdRR(Adversary):
    ...
    def attack(
        ...
        for restart in range(self.restarts):
            ...
            advex, achieved_loss = targeted_pgd.attack(
                advex,
                state,
                init_hx
            )
